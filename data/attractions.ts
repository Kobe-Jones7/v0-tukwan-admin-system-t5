...
const attractions: Attraction[] = [
	...
	},
	{
		...
		highlights: [
			"The marble mausoleum where Nkrumah and his wife are entombed • The museum containing Nkrumah's personal effects and historical artifacts • The statue of Nkrumah with his famous declaration 'Ghana, your beloved country is free forever' • Beautiful fountains that perform a synchronized water display • Extensive photo gallery documenting Nkrumah's life and political career",
		],
		practicalInfo: {
	...
	},
	{
		...
		practicalInfo: {
			...
			accessibility:
				"Crowded with narrow pathways, challenging for those with mobility issues",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Weekday mornings for a more relaxed shopping experience",
			accessibility: "Mostly accessible with some uneven pathways",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			entryFee: "Free",
			bestTimeToVisit:
				"Afternoons for shopping, evenings for dining and nightlife",
	...
	},
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Early morning for wildlife viewing, especially during the dry season (October to March)",
			accessibility:
				"Limited accessibility with rugged terrain and hiking required for many attractions",
		},
	...
	},
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Rainy season (May to October) for the most impressive water flow",
			accessibility:
				"Requires a moderate 30-45 minute hike on uneven terrain",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Weekday mornings for fewer crowds, dry season (November to March) for clearer water",
			accessibility:
				"Varies by beach, with Labadi being the most developed with facilities",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			accessibility:
				"Main viewpoints are accessible, but port tours may involve walking on uneven surfaces",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			accessibility:
				"Limited accessibility with uneven surfaces and stairs",
		},
		images: [
	...
	// Central Region Attractions
	{
		...
		practicalInfo: {
			...
			accessibility:
				"Limited accessibility with many stairs and uneven surfaces",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			accessibility:
				"Limited accessibility with many stairs and narrow passages",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			entryFee: "GH₵20 for Ghanaians, GH₵40 for foreign visitors",
			bestTimeToVisit:
				"Any time during opening hours as it rarely gets crowded",
			accessibility:
				"Limited accessibility with stairs and uneven surfaces",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			entryFee: "GH₵15 for Ghanaians, GH₵30 for foreign visitors",
			bestTimeToVisit:
				"Late afternoon for the best lighting for photography and views",
			accessibility:
				"Limited accessibility with a steep hill climb and uneven surfaces",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Early morning for wildlife viewing and smaller crowds",
			accessibility:
				"Limited accessibility with forest trails and the canopy walkway requiring good mobility",
		},
		images: [
	...
	// Eastern Region Attractions
	{
		...
		practicalInfo: {
			...
			entryFee: "GH₵20 for Ghanaians, GH₵40 for foreign visitors",
			bestTimeToVisit:
				"Year-round, but especially pleasant during the dry season (November to March)",
	...
	},
	{
		...
		practicalInfo: {
			...
			entryFee: "GH₵15 for Ghanaians, GH₵30 for foreign visitors",
			bestTimeToVisit:
				"Rainy season (May to October) for maximum water flow",
			accessibility:
				"Requires moderate hiking; not suitable for those with mobility issues",
		},
		images: [
	...
	// Volta Region Attractions
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Rainy season (April to October) for the most impressive water flow",
			accessibility:
				"Requires a 45-minute hike through forest terrain; not suitable for those with mobility issues",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Dry season (November to March) for clearer views and easier hiking",
			accessibility:
				"Requires strenuous hiking; only suitable for physically fit individuals",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Dry season (November to March) for clearer water and better weather",
			accessibility:
	...
	// Northern Region Attractions
	{
		...
		practicalInfo: {
			...
			entryFee: "GH₵40 for Ghanaians, GH₵100 for foreign visitors",
			bestTimeToVisit:
				"Dry season (November to April) for best wildlife viewing",
			accessibility:
				"4WD vehicle recommended; limited accessibility for those with mobility issues",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			accessibility:
				"Limited accessibility; visitors should dress modestly",
		},
		images: [
	...
	// Western Region Attractions
	{
		...
		practicalInfo: {
			...
			bestTimeToVisit:
				"Dry season (November to March) for easier canoe access",
			accessibility:
				"Not suitable for those with mobility issues due to canoe travel and uneven walkways",
		},
		images: [
	...
	},
	{
		...
		practicalInfo: {
			...
			accessibility:
				"Limited accessibility due to forest terrain and lack of paved paths",
		},
		images: [
	...
	// Upper East Region Attractions
	{
		...
		practicalInfo: {
			...
			entryFee: "GH₵20 for Ghanaians, GH₵40 for foreign visitors",
			bestTimeToVisit:
				"Dry season (November to March) when crocodiles are more visible",
			accessibility:
				"Mostly accessible with some uneven ground around the ponds",
		},
		images: [
